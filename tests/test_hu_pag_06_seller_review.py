...
def test_bandeja_muestra_pendientes(real_db_context):
...
def test_confirmar_marca_pagado(real_db_context):
    client, db, token_for, _mail = real_db_context
...
def test_rechazar_libera_stock_y_cancela(real_db_context):
    client, db, token_for, _mail = real_db_context
...
def test_revisar_dos_veces_da_409(real_db_context):
    client, db, token_for, _mail = real_db_context
...
def test_pago_de_otra_tienda_da_404(real_db_context):
    client, db, token_for, _mail = real_db_context
