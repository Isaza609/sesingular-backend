...
def test_pedido_nuevo_sin_responsable(integration_context):
...
def test_asignar_y_reasignar_con_historial(integration_context):
    client, db, token_for, _mail = integration_context
...
def test_filtro_por_responsable_y_sin_asignar(integration_context):
    client, db, token_for, _mail = integration_context
...
def test_asignar_a_usuario_ajeno_da_400(integration_context):
    client, db, token_for, _mail = integration_context
...
def test_otro_miembro_puede_actuar_pese_a_responsable(integration_context):
    client, db, token_for, _mail = integration_context
